...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO toyota (make, model, price, year, fueltype, color, bhpower, drivetype, quantity, mileage, image, image2, image3, image4, image5, image6, url) VALUES ('$make', '$model', '$price', '$year', '$fueltype', '$color', '$bhpower', '$drivetype', '$quantity', '$mileage', '$image','$image2','$image3','$image4','$image5','$image6', '$url')";
...
<body>
    ...
    <?php include('/xampp/htdocs/TEAM10/footer.php');?>
        ...
        $filename = "TEAM10/$url.php";
        $file = fopen($filename, "w");
        fwrite($file, $template);
        fclose($file);

        // Redirect to the car page
        echo "<script> alert('Data was Inserted!!!'); window.location = 'admin_add_toyota_car.php'</script>";
        exit();
    } else {
