...
public class AddEmployeeForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Create A New Employee");
        ...
        CreateUserButton.setText("Create Employee");
    ...
    private void CreateUserButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateUserButtonActionPerformed
        ...
        try {
            ...
            statement = con1.prepareStatement("insert into java_employee (email,password) values ( ? , ?)");

            statement.setString(1, email);
            statement.setString(2, password);

            statement.executeUpdate();
            JOptionPane.showMessageDialog(null, "Emloyee Created!!!");
