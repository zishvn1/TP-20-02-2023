$(document).ready(function() {
	...
	$('#make').on('change', function() {
		...
		if (make == 'Volkswagen' ) { // if the selected make is Volkswagen
		...
		} else if (make == 'BMW') { // if the selected make is BMW
		...
		} else if (make == 'Mercedes') { // if the selected make is Mercedes
		...
		} else if (make == 'Toyota') { // if the selected make is Toyota
		...
		} else if (make == 'Audi') { // if the selected make is Audi
		...
		} else { // if no make is selected, disable the "model" dropdown
	...
	$('#filter-form').on('submit', function(e) {
		...
		$.ajax({
			...
			url: 'filter.php', // specify the URL for the 
				  data: formData,
				  success: function(result) { // displays the cars in correlation to the specified filters
