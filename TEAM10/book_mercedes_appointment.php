...
if (isset($_POST['book'])) {
    ...
    if (mysqli_query($con, $sql)) {
        ...
        try {
            ...
            echo "<script> alert('Error sending email!!!'); window.location = 'book_mercedes_appointment.php'</script>";
            '' . $mail->ErrorInfo;
        }
    } else {
        echo "<script> alert('Error!!!'); window.location = 'book_mercedes_appointment.php'</script>";
