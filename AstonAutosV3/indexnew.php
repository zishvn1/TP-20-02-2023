...
<body>
    ...
    <body class="body-content">
        ...
        <div class="main-container">
            <img src="images/indexnew/main.png">
            ...
            <div class="column-container">
                <div class="column">
                    ...
                    <a href="filterNew.php" class="centered-button">Shop For Cars</a>
                </div>
                <div class="column">
                    <img src="images/indexnew/column1.jpg">
                </div>
            </div>

            <div class="column-container">
                <div class="column">
                    <img src="images/indexnew/column2.jpg">
                </div>
                <div class="column">
                    ...
                    <a href="contactus.php" class="centered-button">Book A Test Drive</a>
                </div>
            </div>
            ...
            <div class="column-container">
                ...
                <div class="column">
                    <img src="images/indexnew/column3.jpg">
                </div>
            </div>
