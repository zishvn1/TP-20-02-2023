                ...
                <table class="table" cellpadding="100" cellspacing="1" style="margin-left:auto; margin-right:auto;">
                    <tbody>
                        <tr><!--These are the table column names -->
                            ...
                            if (!empty($_SESSION['cart'])) {
                                $carssql = "SELECT * FROM carProducts WHERE id IN (" . implode(',', $_SESSION['cart']) . ")";;
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;"><a href="AddToBasketInBasket.php?id=<?php echo $carrow['id'] ?>"><span class="glyphicon glyphicon-plus" style="color: grey;"></span></a>
                                <td style="text-align:center;"></span></a><a href="DeleteItemFromBasket.php?id=<?php echo $carrow['id'] ?>"> <span class="glyphicon glyphicon-minus"></span></button></a>

                            </tr>
                    <?php
                                    // Cost of all mercedes products in mercedes' basket are added to $totalCost
                                    $totalCost = $totalCost + $carrow['price'] * count(array_keys($_SESSION['cart'], $id));
                                }
                            }
