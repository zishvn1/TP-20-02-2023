...
<body>
    ...
    <!-- Feature was added for security reasons-->
        <div id="timer">
            <p style="font-size: 3vw;">05:00</p></div>
            <p style="font-size: 2vw;">Before you are automatically signed out</p>
        <script>
...
// and inserts those values into the database called orders
            ...
            if (!empty($_SESSION['cart'])) {
                $carssql = "SELECT * FROM products WHERE id IN (" . implode(',', $_SESSION['cart']) . ")";;
                ...
                VALUES('$OrderId','$Make','$Model','$Quantity','$Price')";
                    ...
                    $UpdateQuantity = "UPDATE carProducts SET Quantity = Quantity -$Quantity WHERE id = $id";
