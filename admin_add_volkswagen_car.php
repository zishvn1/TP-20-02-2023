...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO volkswagen (make, model, price, year, fueltype, color, bhpower, drivetype, quantity, mileage, image, image2, image3, image4, image5, image6, url) VALUES ('$make', '$model', '$price', '$year', '$fueltype', '$color', '$bhpower', '$drivetype', '$quantity', '$mileage', '$image','$image2','$image3','$image4','$image5','$image6', '$url')";
...
<body>
    ...
    <?php include('/xampp/htdocs/TEAM10/footer.php');?>
        ...
        echo "<script> alert('Data was Inserted!!!'); window.location = 'admin_add_volkswagen_car.php'</script>";
        exit();
    } else {
        $_SESSION['success'] = "Data not Inserted";
        echo "<script> alert('Data not Inserted!!!'); window.location = 'admin_add_volkswagen_car.php'</script>";
    }
}
...
<body>
    ...
    <div class="containerAddInventory ">
        <div class="form signup">
            <div class="content">
                <span class="title">Add to Volkswagen </span>
