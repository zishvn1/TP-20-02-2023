...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO bmw (make, model, price, year, fueltype, color, bhpower, drivetype, quantity, mileage, image, image2, image3, image4, image5, image6, url) VALUES ('$make', '$model', '$price', '$year', '$fueltype', '$color', '$bhpower', '$drivetype', '$quantity', '$mileage', '$image','$image2','$image3','$image4','$image5','$image6', '$url')";
...
<body>
    ...
    <?php include('/xampp/htdocs/TEAM10/footer.php');?>
        ...
        echo "<script> alert('Data was Inserted!!!'); window.location = 'admin_add_bmw_car.php'</script>";
        exit();
    } else {
...
<body>
    ...
    <div class="containerAddInventory ">
        <div class="form signup">
            <div class="content">
                <span class="title">Add to Bmw </span>
